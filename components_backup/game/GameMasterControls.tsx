...
import { Loader2, ChevronsRight, PlaySquare, TrendingUp, Sparkles, ChevronRightSquare } from 'lucide-react';
...
const GameMasterControls: React.FC<GameMasterControlsProps> = ({
  ...
  const canAdvanceDay_AfterStep5 =
    gameData.currentDayStep === 5 &&
    !!gameData.currentDayResults &&
  ...
  return (
    <div className="mt-8 p-4 border-t flex flex-col items-center space-y-3">
      <h3 className="text-lg font-semibold text-primary">Game Master Controls (Day {gameData.currentDay}, Step: {calculatedDisplayRoundNumber}/5)</h3>
